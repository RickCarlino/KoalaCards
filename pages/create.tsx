...
const FeatureCard = ({ icon, title, description, buttonText, onClick }: FeatureCardProps) => {
    ...
    >
      ...
      {title === "From Word Lists" && (
        <Text size="xs" mb="md" c="dimmed" style={{ textAlign: 'center' }}>
          <Text component="a" href="/frequency-lists" style={{ textDecoration: 'underline', cursor: 'pointer' }}>
...
const CreatePage = () => {
  ...
  const features = [
    {
      ...
      title: "From Vibes",
      description: "Perfect for casual users just trying the app. Tell the AI what you want to learn, and it creates cards based on your request. Great for exploring new topics!",
    ...
    },
    {
      ...
      title: "From Word Lists",
      description: "Ideal for serious learners with specific words to learn. Your words will be transformed into example sentences with definitions. Perfect for frequency lists or reading goals.",
    ...
    },
    {
      ...
      title: "From CSV",
      description: "For users with existing data from other spaced repetition systems like Anki. Import your CSV data directly and continue your learning journey.",
  ...
  return (
    <Container size="lg" mt={{ base: "md", sm: "xl" }} style={{ position: "relative" }}>
      <Box mb="xl" ta="center">
        <Title order={1} mb="sm">Create New Cards</Title>
      ...
      <Box mt="xl" p="md" style={{ backgroundColor: theme.colors.pink[0], borderRadius: theme.radius.md }}>
        <Text ta="center" fw={500}>
          Not sure which to choose? Start with "Create by Vibe" for the easiest experience!
        </Text>
      </Box>
    </Container>
  );
