...
import { Button, Group, Paper, Title, Text, Container, Card, Badge, Box, useMantineTheme } from "@mantine/core";
              ...
              >
                <Group justify="space-between" align="center">
                  <Group>
                    ...
                    <Link href={`/review/${deck.id}`} style={{ textDecoration: 'none' }}>
                  ...
                  {cards && (
                    <Group gap="xs">
                      {deck.quizzesDue > 0 && (
                        <Badge color="pink" variant="light" size="lg" radius="md">
                          {deck.quizzesDue} due
                        </Badge>
                      )}
                      {deck.newQuizzes > 0 && (
