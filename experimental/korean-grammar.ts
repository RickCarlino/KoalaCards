export const koreanGrammar = {
  ...
  "-(느)ㄴ/는 줄 알았다/몰랐다":
    "Different information from what was expected (I thought... but...)",
  ...
  "-(으)ㄴ 감이 있다":
    "Expresses certain feeling or thoughts from observing something",
  "-(으)ㄴ 지 N(Time)이/가 되다/넘다/지나다":
    "Indicates how much time has passed after doing something",
  "-(으)ㄴ 채(로)": "Describes action taken in the process of another action",
  "-(으)ㄴ/는": "Modifies the following noun",
  "-(으)ㄴ/는 것 같다":
    "Expresses guess, thought, or opinion based on fact or situation",
  "-(으)ㄴ/는 대신(에)":
    "Indicates changing P1's matter into P2 or rewarding P2 due to P1",
  "-(으)ㄴ/는 데다가": "Adds related information from P2 to P1",
  "-(으)ㄴ/는 듯하다": "Speculates based on certain fact or situation",
  "-(으)ㄴ/는 모양이다":
    "Speculates based on certain fact or situation (shape or appearance)",
  "-(으)ㄴ/는 반면(에)": "Contrasts context of P1 with P2",
  "-(으)ㄴ/는 법이다": "Indicates natural or certain occurrence",
  "-(으)ㄴ/는 셈이다":
    "Indicates similarity or considering something as similar",
  "-(으)ㄴ/는 척하다":
    "Fabricating attitude or action different from fact (act like...)",
  "-(으)ㄴ/는 체하다":
    "Acting differently from actual condition (acted as though...)",
  ...
  "-(으)ㄴ/는지 알다/모르다":
    "Asking awareness of certain information (do you know...)",
  ...
  "-(으)ㄹ 리(가) 없다/있다":
    "Express that P1 is not true based on fact or situation",
  "-(으)ㄹ 만하다":
    "Recommend something considered worthy; express available level",
  ...
  "-(으)ㄹ 수밖에 없다":
    "No other choice but to do P1's action or be in P1's state",
  "-(으)ㄹ 정도로": "Degree of P2 is same as P1 (so...that...)",
  "-(으)ㄹ 지경이다": "Condition similar to something else (about to)",
  "-(으)ㄹ 테니(까)":
    "P1 is strong supposition and reason for P2; P1 shows speaker's will",
  "-(으)ㄹ 텐데":
    "Speculation as basis for succeeding phrase; actual situation",
  ...
  "-(으)ㄹ지도 모르다":
    "Indicates possibility of something happening (but unlikely)",
  "-(으)라고 하다": "Citation - Imperative sentences",
  "-(으)려고 하다":
    "Explain future plans; likely to happen; plan didn't materialize",
  "-(으)려던 참이다":
    "Plan for foreseeable future; just about to do suggested action",
  ...
  "-거든요":
    "Respond to question or add reason/thinking behind answer/statement",
  "-건만": "Opposite facts between P1 and P2",
  "-게": "Show purpose towards action of P1 (in order for/so that)",
  "-게 되다":
    "Something changed/happened due to reason (passive, no intention)",
  ...
  "-기(가) 무섭게":
    "Doing something as soon as something is finished (as soon as)",
  ...
  "-는 수가 있다":
    "Possibility that something might happen due to certain action",
  ...
  "-다 보니":
    "Learned something new after continuous action; certain situation",
  "-다 보면": "P2 action may be realized if P1 action continued/repeated",
  "-다가":
    "Something done on the way; other action taken during certain action",
  ...
  "-아/아 가다/오다":
    "가다: current situation maintained in future; 오다: past to present",
  "-아/아 봤자": "Even if P1's work done, expected result not realized",
  "-아/어 가지고":
    "P1's completed result becomes reason for P2 (since/because)",
  ...
  "-아/어 두다":
    "Action done in advance and being continued (focus on completion)",
  "-아/어 버리다": "Emphasize something completely done (final state/result)",
  "-아/어 보이다":
    "Conjecture/feelings based on outward appearance (you look...)",
  ...
  "-아/어서는":
    "Something in P1 makes it impossible for something to be accomplished",
  ...
  "-아/어지다 (V)":
    "Something not done directly by subject but by something else",
  "-았/었다가": "Contrasting action; noteworthy/unexpected event after action",
  "-았/었더니":
    "Recognized after doing certain action; state result after action",
  ...
  "어찌나 -(으)ㄴ/는지":
    "Emphasize P1 when it is the cause of P2 (I can't believe)",
  "얼마나 -(으)ㄴ/는지 모르다":
    "Emphasize greatness of fact/situation (You have no idea how)",
