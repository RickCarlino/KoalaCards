...
describe('MicrophonePermissions', () => {
  ...
  it('shows waiting message while requesting permissions', () => {
    ...
    expect(screen.getByText('Requesting microphone permission...')).toBeInTheDocument()
    expect(screen.getByText('Please allow microphone access to continue')).toBeInTheDocument()
  ...
  it('renders child element after permissions granted', async () => {
    ...
    expect(screen.queryByText('Requesting microphone permission...')).not.toBeInTheDocument()
  })
  ...
  it('shows error message when permission denied', async () => {
    ...
    expect(await screen.findByText('Microphone Access Error')).toBeInTheDocument()
