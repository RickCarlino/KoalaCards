...
export function useInstapaperControls() {
  ...
  return {
    ...
    isConnecting: connectInstapaper.isPending,
    isDisconnecting: disconnectInstapaper.isPending,
    isLoadingUnread: loadUnread.isPending,
    isImportingUnread: importUnread.isPending,
